...
* Click the group which contains the HTTP server you want to delete (for example, Default)
...
* Click the App Servers icon on the left tree menu
    ...
    <img src="../images/http_8.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* Locate the HTTP server you want to delete, either in the tree menu or on the summary page

    <img src="../images/http_9.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* Click the icon for the HTTP server

    <img src="../images/http_10.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* Click Delete

    <img src="../images/http_11.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* A confirmation message displays. Confirm the delete and click OK

    <img src="../images/http_12.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->
