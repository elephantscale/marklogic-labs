...
* Click the Merge button on the Database Configuration page
    ...
    <img src="../images/db_16.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* Confirm that you want to merge the forest data in this database and click OK

    <img src="../images/db_17.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* You successfully mearged the database
