...
* Click the group which contains the XDBC server you want to delete (for example, Default)
...
* Locate the XDBC server you want to delete, either in the tree menu or on the summary page

    <img src="../images/xdbc_6.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* Click the icon for this XDBC server

    <img src="../images/xdbc_7.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* Click Delete

    <img src="../images/xdbc_8.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->

* A confirmation message displays. Confirm the delete and click OK

    <img src="../images/xdbc_9.jpg" style="width:80%;"/> <!-- {"left" : 0.26, "top" : 1.45, "height" : 6.17, "width" : 9.74} -->
